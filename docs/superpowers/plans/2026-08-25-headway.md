    ...
    ColumnLayout {
      ...
      Repeater {
        ...
        delegate: RowLayout {
          ...
          Text {
            ...
            text: {
              var parent = Stations.parentOf(arrivalRow.modelData.destinationStopId)
              var dest = Stations.byId(parent)
      ...
      Repeater {
        ...
        delegate: RowLayout {
          ...
          Layout.fillWidth: true
          Button {
            text: (Stations.byId(savedRow.modelData.stopId) || { name: savedRow.modelData.stopId }).name
