...
**Include these three probe facts, established during implementation. They
decide what can be verified without restarting the shell, which is the
single most useful thing to know when changing this plugin:**
