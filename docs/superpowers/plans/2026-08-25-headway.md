...
**Why the `Planned - ` prefix is load-bearing (spec finding 15):** 151 of 195 alerts are planned engineering work, much of it for future weekends. Treating them as live disruption leaves the glyph amber permanently, which is the same as having no severity signal at all.
