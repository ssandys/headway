...
Panel {
  ...
  KeyboardPanel {
    ...
    ColumnLayout {
      ...
      Repeater {
        model: service.saved
          ? Model.alertsFor(service.saved.routes, service.alerts, service.nowSec)
          : []
        delegate: Text {
          id: alertRow
          required property var modelData
