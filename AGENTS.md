...
| **`active_period` filtering is mandatory** | 144 of 199 alerts are `Planned - ` engineering work, much of it for weekends days away. Unfiltered, the glyph pins amber forever. 195 alerts filter down to 7. |
